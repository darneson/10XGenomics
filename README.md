...
2. These files can be obtained directly from the sequencer while it is running using [LiveSync](https://github.com/darneson/10XGenomics/blob/master/LiveSyncInstructions.txt) <br />
