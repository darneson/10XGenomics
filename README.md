...
1. For 10X single cell analysis, we need raw files directly from the sequencer (.bcl files) <bc />
    1.1 We also need all of the files off the sequencer which describe the flow cell settings <bc />
